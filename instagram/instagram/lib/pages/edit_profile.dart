...
class _EditProfileState extends State<EditProfile> {
                  ...
                  style: TextStyle(
                    ...
                    onPressed: (){
                      if (nameController.text == ''){
                        ...
                        MaterialPageRoute(
                          builder: (context) => Profile(id: idController.text, name: nameController.text, bio: bioController.text, image: imageController.text ),
                        ),
                        );
                      }
  ...
  showAlertDialogMaterial(Text){
    showDialog(context: globalkey.currentContext,
    builder: (_) => AlertDialog(title: Text('Info'),
    content: Text(Text),
    actions: [
